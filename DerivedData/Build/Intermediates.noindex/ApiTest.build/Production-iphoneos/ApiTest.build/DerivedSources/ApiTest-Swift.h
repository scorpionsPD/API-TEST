...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ApiTest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7ApiTest11AppDelegate")
...
SWIFT_CLASS("_TtC7ApiTest26MovieDetailsViewController")
...
SWIFT_CLASS("_TtC7ApiTest14RequestCreator")
